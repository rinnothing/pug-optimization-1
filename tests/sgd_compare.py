...
print("type\t batch\t l_1\t l_2\t moment\t func\t deviation\t iter\t calls\t grad")

def launch(name, batch_size, l_1, l_2, moment):
    num = 1
    for f in common.datasets.func_dataset:
        ...
        print(name, batch_size, l_1, l_2, moment, num, average_test[0], len(res.guesses),
